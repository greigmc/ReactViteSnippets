...
export default function Footer() {
  ...
  return (
    <>
      <Container
        fluid
        className="bg-primary-custom bg-dark text-start text-light pt-5 mt-5"
      >
        <Container>
          <Row>
            <Col sm={6}>
              <div className="widget about">
                ...
                <p className="d-flex justify-content-start">
                  ...
                  Management. My skillset allows me to implement a business
                  savvy approach to creating secure bespoke websites. My working
                  style is to liaise closely with my clients to fully understand
                  and implement their requirements, ensuring the website
                  fulfills both the brief and their objectives.
                </p>
                ...
                <p>
                  Email:
                  <a
                    href="mailto:info@greigmcmahon.com"
                    target="_top"
            ...
            <Col
              sm={6}
              className="d-flex justify-content-around flex-direction-column"
            >
        ...
        <Container>
          <Row>
            ...
            <Col sm={12} className="justify-content-centre">
              <CookieConsent
                style={{ background: "rgba(10, 10, 10, 1.9)" }}
                enableDeclineButton
              ...
              >
                ...
                technologies for technical purposes and, with your consent. Use
                the “Accept” button to consent. Use the “Decline” button or
