...
const text = {
  ...
  textRev:
    "Et quos autem ab ullam consequuntur ea quisquam obcaecati. Sit fugiat dicta eum quia nostrum et quibusdam soluta. In molestiae reprehenderit sed accusantium rerum et laborum officiis quo unde nostrum ab temporibus suscipit ea tenetur omnis. Qui unde ratione aut voluptates natus vel nihil omnis qui ducimus dolorum et nisi deleniti in impedit sint.",
  textShort:
    ...
    <Container className="my-5">
      ...
      <Row className="m-0 overflow-hidden d-flex justify-content-center flex-row">
        ...
        <Col
          ...
          md={6}
          sm={12}
          className="my-4 overflow-hidden d-flex justify-content-start"
        >
          <Image src={image.img} />
        </Col>
      ...
      <Row className="m-0 overflow-hidden d-flex justify-content-center flex-row-reverse">
        ...
        <Col
          ...
          md={6}
          sm={12}
          className="my-4 overflow-hidden d-flex justify-content-end"
        >
          <Image src={image.imgTwo} />
        </Col>
        <Col lg={6} md={6} sm={12} className="text-start">
      ...
      <Row className="m-0 overflow-hidden d-flex justify-content-center flex-row">
        ...
        <Col lg={4} md={4} sm={12} className="my-4 overflow-hidden text-start">
          <Image src={image.img} alt="" height={200} />
          <h5 className="my-3 text-center">{heading.heading}</h5>
          <p>{text.textShort}.</p>
        </Col>
        <Col lg={4} md={4} sm={12} className="my-4 overflow-hidden text-start">
          <Image src={image.imgTwo} alt="" height={200} />
