    ...
    <Container className="my-5">
      <section>
        ...
        <div className="my-4">
          ...
          <Row>
            <Col className="border border-danger mb-2">1 of 3</Col>
            <Col className="border border-danger mb-2" xs={6}>
              2 of 3 (wider)
            </Col>
            <Col className="border border-danger mb-2">3 of 3</Col>
          </Row>
          ...
          <Row>
            <Col className="border border-danger mb-2">1 of 4</Col>
            <Col className="border border-danger mb-2" xs={2}>
              3 of 4
            </Col>
            <Col className="border border-danger mb-2" xs={2}>
              3 of 4
        ...
        <div className="my-4">
          ...
          <Row className="justify-content-md-center my-5">
            ...
            <Col className="border border-danger mb-2" md="auto">
        ...
        <div className="my-4">
          ...
          <p>
            The Col lets you specify column widths across 6 breakpoint sizes xs,
            sm, md, lg, xl and xxl.
          </p>
          <Row>
            <Col className="border border-danger mb-2" sm={8}>
              sm=8
            </Col>
            <Col className="border border-danger mb-2" sm={4}>
              sm=4
            </Col>
          </Row>
          <Row>
            <Col className="border border-danger mb-2" sm>
              sm=true
            </Col>
            <Col className="border border-danger mb-2" sm>
              sm=true
        ...
        <div className="my-4">
          ...
          <p>
            The Row lets you specify column widths across 6 breakpoint sizes xs,
            sm, md, lg, xl and xxl. For every breakpoint, you can specify the
