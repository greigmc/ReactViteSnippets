  ...
  return (
    <Container className="my-5">
      <section className="container">
        ...
        <h4>
          Theming the navbar using classes and background-color utilities.{" "}
        </h4>
        <hr></hr>
        ...
        <Navbar
          expand="sm"
          className="bg-body-primary px-4"
          bg="primary"
          data-bs-theme="dark"
        >
        ...
        <hr></hr>
        <h3 id="home" className="my-5">
          Responsive Scrolling NavBar
        </h3>
        <h4>
          navbarScroll prop in a to enable vertical scrolling within the
          toggleable contents of a collapsed navbar.
        </h4>
        <hr></hr>
        <Navbar
          expand="lg"
        ...
        <section id="scroll" className="my-5">
          ...
          <Row className="my-5">
            ...
            <Col lg={6} md={6} sm={12}>
              <img src={imageOne} alt="image" height={200} />{" "}
            </Col>
          </Row>
          <Row className="my-5">
            <Col lg={6} md={6} sm={12}>
