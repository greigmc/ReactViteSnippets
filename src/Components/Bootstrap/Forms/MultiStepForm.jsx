...
export default function MultiStepFormVal() {
  ...
  const handleChange = (e) => {
    ...
    const value = e.target.type === "type" ? e.target.checked : e.target.value;
    setState({
      ...state,
      [name]: value,
    });
    ...
    <Container fluid>
      ...
      <Row className="d-felx justify-content-center">
        <Col
          lg={10}
          sm={10}
          className="bg-light text-dark p-4 mt-2 form-shadow"
        >
          <Form
          ...
          >
                  ...
                  <Col lg={12} sm={12}>
                    <Form.Group className="mb-4">
                      ...
                      <Form.Control
                        ...
                        value={
                          currency !== ""
                            ? currentcyFormat.format(currency)
                            : ""
                        }
                        onChange={handleInputChange}
                      />
                  ...
                  <Col lg={8} sm={8} className="mb-4">
                    <Card className="form-shadow text-center py-4">
                      <Card.Body className="">
                        ...
                        <Card.Text>
                          Make sure you click the activation link contained in
                          the email within the next 24 hours.
                        </Card.Text>
                        <Button variant="primary multi" href="/">
                          Home Page
                        </Button>
                      </Card.Body>
                    </Card>
            ...
            <div className="d-flex justify-content-between">
              ...
              {step < 3 ? (
                ...
                <Button variant="primary multi">Submit</Button>
              )}
            </div>
          </Form>
      ...
      <p className="d-flex justify-content-center mt-5">
        This website is validated as a secure site for sending and receiving
        sensitive data.{" "}
      </p>
    </Container>
  );
