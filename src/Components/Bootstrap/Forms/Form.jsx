    ...
    <Container className="my-5">
      <section>
        ...
        <p>
          ...
          styling. The FormGroup component wraps a form control with proper
          spacing, along with support for a label, help text, and validation
          state. To ensure accessibility, set controlId on FormGroup, and use
        ...
        <p>
          ...
          browsers, the :valid and :invalid pseudo selectors are used to apply
          validation styles as well as display feedback messages.
        </p>
        <Row className="text-start justify-content-center">
