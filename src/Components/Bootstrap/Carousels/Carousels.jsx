  ...
  return (
    <Container className="my-5">
      <div className="container" data-bs-theme="light">
        ...
        <p>
          Allow the component to control its own state with interval set to 2.5
          seconds
        </p>
        <hr></hr>
        <Row>
        ...
        <p>
          Control the Carousel state, via the activeIndex prop and onSelect
          handler.
        </p>
        <hr></hr>
        ...
        <p>
          Add the fade prop to your carousel to animate slides with a fade
