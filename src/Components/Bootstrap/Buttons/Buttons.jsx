    ...
    <Container className="my-5">
      <section>
        ...
        <Button
          ...
          className="mb-3 border border-danger text-danger"
        >
          Light
        </Button>{" "}
        ...
        <h3>Button tags</h3>
        <p>
          Normally Button components will render a HTML button element. However
          you can render whatever you would like, adding a href prop will
          automatically render an <a /> element. You can use the as prop to
          render whatever your heart desires.
        </p>
        <hr></hr>
        <Button href="HomePage" className="m-2">
          Link
        </Button>
        ...
        <h3>Button Sizes</h3>
        <p>
          Fancy larger or smaller buttons? Add size= Add size=&quot;lg&quot;,
        ...
        <p>
          ...
          pattern to give the user feedback as to the loading state
        </p>
        <hr></hr>
        <Button
          variant="primary"
