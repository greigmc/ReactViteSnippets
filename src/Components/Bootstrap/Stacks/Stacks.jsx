    ...
    <Container className="my-5">
      <section className="container">
        ...
        <h4>
          ...
          default. Use the gap prop to add space between items.
        </h4>
        <hr></hr>
        <Row>
          <Col>
        ...
        <h4>
          ...
          default and only take up their necessary width. Use the gap prop to
        ...
        <Row>
          <Col className="mb-2">
            <Stack direction="horizontal" gap={3}>
              <div className="border border-danger mb-2 p-2">First item</div>
              <div className="border border-danger mb-2 p-2 ms-auto">
                Second item
              </div>
              <div className="border border-danger mb-2 p-2">Third item</div>
            </Stack>
